...
Plant cards represent the user-selectable units in the game. Each card corresponds to a specific plant type and contains visuals and metadata used in the game’s planting system.
...
## • Jalapeño Card  
**Plant:** Jalapeño | **Role:** Lane Bomb  
Destroys all zombies in an entire row with a fiery explosion.  
![Jalapeño Card](resources/graphics/Cards/card_jalapeno.png)
...
# Plants vs. Zombies – Plant Encyclopedia
...
![Jalapeño](resources/graphics/Plants/Jalapeno/Jalapeno/Jalapeno_0.png)
...
## 🧩 **Additional Plants**  
These plants provide unique abilities that don’t fit into the other categories.
...
---
# Plants vs. Zombies – Zombie Encyclopedia
